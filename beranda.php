...
<div class="container">
	<div class="grid">
		<div class="row">
            <div class="border padding20 span10" style="background-color: #F5F5F5; float: right;">
				<div class="panel no-border">
					<?php
						$comot=	mysql_query("SELECT * FROM setup_dasboard ORDER BY id_dasboard DESC LIMIT 3");   
						while($ngisi=	mysql_fetch_array($comot)){
					?>
                    <div class="panel-header ribbed-dark fg-white"><strong><?php echo $ngisi['nama']; ?></strong></div>
			...
			<div class="padding20 span4" style="background-color: #F1F1F1; float: left;">
				<div class="panel no-border">

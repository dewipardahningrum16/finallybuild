        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li><a href="setupBandungProfil.php">Profil</a></li>
                        <li><a href="setupBandungSejarah.php">Sejarah</a></li>
                        <li><a href="setupBandungWisata.php">Pariwisata</a></li>
                        <li><a href="setupBandungKuliner.php">Kuliner Khas</a></li>
                        <li><a href="setupBandungBudaya.php">Seni &amp; Budaya</a></li>
                    </ul>
                </li>
            </ul>
            <!-- /#side-menu -->

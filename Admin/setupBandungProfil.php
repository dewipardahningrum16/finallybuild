                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row col-lg-10">
                        	<form name="setupBandungProfil" action="setupBandungProfil.php" method="post" enctype="multipart/form-data">
							<?php
								if (isset($_GET['id']))
								{
								...
								?>
                                    <tr>
                                        ...
                                        <div class="tooltip-demo">
                                            <a href="setupBandungProfil.php?id=<?php echo $isi_tbl[0]; ?>"><button type="button" class="btn btn-primary btn-xs"data-toggle="tooltip" data-placement="top" title="Edit/Hapus Content Profil"><i class="fa fa-wrench"></i></button></a>
                                   		</div>
                                        </td>
                                    </tr>
                                <?php
